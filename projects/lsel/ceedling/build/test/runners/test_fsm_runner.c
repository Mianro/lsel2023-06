...
int main(void)
{
  ...
  run_test(test_fsm_validTransitionNoOutput, "test_fsm_validTransitionNoOutput", 35);
  run_test(test_fsm_validTransitionWithOutput, "test_fsm_validTransitionWithOutput", 55);
